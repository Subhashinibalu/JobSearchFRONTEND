...
inline
label={
<Avatar alt="User settings" img="https://cdn-icons-png.freepik.com/256/9634/9634195.png?ga=GA1.1.937687561.1710832007&semt=ais_hybrid" rounded />
}
>
<Dropdown.Header>
<span className="block text-sm text-blue-700 font-semibold"><Link to='/login'>Login</Link></span>
...
{/* pages */}
<Navbar.Collapse >
<Navbar.Link active={path === '/home'}  as={'div'}><Link to='/' >Home</Link></Navbar.Link>
